...
class FuelOptimizer:
    def optimizing_fuel_plan(self,station_with_progress,route_distance_miles,max_range_miles=500,mpg=10,start_fuel_percent=100,fuel_step_miles=10,start_price_per_gallon=None,safety_buffer_gallons=0):
        ...
        start_fuel_units=min(capacity_units,math.floor(start_fuel_miles/fuel_step_miles))
        ...
        while priority_queue:
            ...
            can_buy_fuel=(current_node.get('price_per_gallon') is not None and (current_fuel_units < capacity_units) and not current_node.get("is_destination",False))
            ...
            for next_node_index in range(current_node_index+1,len(nodes)):
                ...
                distance_to_next=next_node['distance_from_start_miles'] - current_node['distance_from_start_miles']
    ...
    def _build_nodes(self,station_with_progress,route_distance_miles,start_price_per_gallon=None):
        """
            Build route nodes:
            - virtual start node
